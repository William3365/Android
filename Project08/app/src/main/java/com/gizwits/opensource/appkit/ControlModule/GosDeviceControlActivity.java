...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private Spinner sp_enum_WiFI_onoff;
	private Spinner sp_enum_cl2;
	private TextView tv_data_wendu_control;
	private SeekBar sb_data_wendu_control;
	private TextView tv_data_wendu;
	...
	private void initView() {
		...
		sp_enum_WiFI_onoff = (Spinner) findViewById(R.id.sp_enum_WiFI_onoff);
		sp_enum_cl2 = (Spinner) findViewById(R.id.sp_enum_cl2);
		tv_data_wendu_control = (TextView) findViewById(R.id.tv_data_wendu_control);
		sb_data_wendu_control = (SeekBar) findViewById(R.id.sb_data_wendu_control);
		tv_data_wendu = (TextView) findViewById(R.id.tv_data_wendu);
	}

	private void initEvent() {

		sp_enum_WiFI_onoff.setSelection(0, false);
		sp_enum_WiFI_onoff.setOnItemSelectedListener(new OnItemSelectedListener() {

			@Override
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

				if (position != data_WiFI_onoff) {
					sendCommand(KEY_WIFI_ONOFF, position);
					data_WiFI_onoff = position;
				}
			}
		...
		sp_enum_cl2.setSelection(0, false);
		sp_enum_cl2.setOnItemSelectedListener(new OnItemSelectedListener() {

			@Override
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

				if (position != data_cl2) {
					sendCommand(KEY_CL2, position);
					data_cl2 = position;
				}
			}
		...
		sb_data_wendu_control.setOnSeekBarChangeListener(this);
	...
	public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
		...
		case R.id.sb_data_wendu_control:
			tv_data_wendu_control.setText(formatValue((progress + WENDU_CONTROL_OFFSET) * WENDU_CONTROL_RATIO + WENDU_CONTROL_ADDITION, 1));
			break;
		default:
			break;
		}
	...
	public void onStopTrackingTouch(SeekBar seekBar) {
		switch (seekBar.getId()) {
		case R.id.sb_data_wendu_control:
			sendCommand(KEY_WENDU_CONTROL, (seekBar.getProgress() + WENDU_CONTROL_OFFSET ) * WENDU_CONTROL_RATIO + WENDU_CONTROL_ADDITION);
			break;
		default:
			break;
		}
	...
	protected void updateUI() {
		...
		sp_enum_WiFI_onoff.setSelection(data_WiFI_onoff, true);
		sp_enum_cl2.setSelection(data_cl2, true);
		tv_data_wendu_control.setText(data_wendu_control+"");
		sb_data_wendu_control.setProgress((int)((data_wendu_control - WENDU_CONTROL_ADDITION) / WENDU_CONTROL_RATIO - WENDU_CONTROL_OFFSET));
		tv_data_wendu.setText(data_wendu+"");
