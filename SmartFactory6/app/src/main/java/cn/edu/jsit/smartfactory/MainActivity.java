...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageView imageLight = findViewById(R.id.img_light);
        /*final ObjectAnimator oa = ObjectAnimator.ofFloat(imageLight,"alpha",1f,0f,1f).setDuration(2000);
        ...
        final Animator animator = AnimatorInflater.loadAnimator(this,R.animator.anim);
        animator.setTarget(imageLight);
