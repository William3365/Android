...
private String uid;
    ...
    private void initView() {
        ...
        humSensorId = (EditText) findViewById(R.id.et_humi_sensor_id);
        humThresholdValue = (EditText) findViewById(R.id.et_humi_threshold_value);
        ...
        Float tempValue = intent.getFloatExtra("temValue", 0);
    ...
    public void onClickSave(View view) {
        ...
        smartFactory.setCameraAddress(cameraAddress.getText().toString());
