...
public class LoginActivity extends BaseActivity {
    ...
    Handler handler=new Handler() {
        ...
        public void handleMessage(Message msg) {
            if(msg.what==1){
                ...
                editor.putString("pwd", ed_psw.getText().toString().trim());
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            ed_psw = findViewById(R.id.account_psw);
            ...
            ed_id.setText(spPreferences.getString("user", ""));
            ed_psw.setText(spPreferences.getString("pwd", ""));
            ...
            btn_login.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    loginUp(ed_id.getEditableText().toString(), ed_psw.getEditableText().toString());
                }
            });
        }
