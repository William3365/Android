...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tv_wd, tv_sd, tv_nh3, tv_co2;
    private boolean i1 = false;//设置初状态
    private boolean i2 = false;
    private boolean i3 = false;
    private boolean shujv = false;
    private double wd, sd, co2, nh3;
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    tv_nh3.setText(df.format(nh3)+"");
                    tv_co2.setText(df.format(co2)+"");
                    break;
            }
        }
    };
    ...
    private void MyRandom() {
        ...
        nh3 = random.nextInt(12 - 6) + 6;
        co2 = random.nextInt(25 - 12) + 12;
        Log.d("----", sd + "--");
    ...
    private void initView() {
        ...
        tv_nh3 = (TextView) findViewById(R.id.tv_nh3);
