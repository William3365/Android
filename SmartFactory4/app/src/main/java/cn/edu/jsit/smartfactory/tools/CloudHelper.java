...
public class CloudHelper {
    ...
    public void getSensorData(Context c, String address, String pejLabel,String sensorId,final DCallback dCallback){
        NetWorkBusiness nb = new NetWorkBusiness(token,address);
        nb.getSensor(pejLabel, sensorId, new NCallBack<BaseResponseEntity<SensorInfo>>(c) {
            @Override
